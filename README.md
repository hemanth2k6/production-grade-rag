...
- **Strict Citation Enforcement:** Ensures the LLM (via `Gemini`) strictly relies on the provided document chunks, stripping any hallucinated citations. If the documents cannot answer the question, the system gracefully declines to answer.
